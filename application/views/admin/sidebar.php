...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    ...
    <div class="menu_section">
        <ul class="nav side-menu">
            ...
            <li><a><i class="fa fa-newspaper-o"></i> Kegiatan <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu" style="display: none">
                    <li><a href="<?php echo site_url('admin/activity') ?>">Daftar Kegiatan</a>
                    <li><a href="<?php echo site_url('admin/activity/category') ?>">Category Kegiatan</a>
                    </li>
                </ul>
            </li>
