...
<?php if (isset($activity)): ?>
            $scope.category_data = {index: <?php echo $activity['activity_category_category_id']; ?>};
...
<?php endif; ?>
        ...
        $scope.addCategory = function() {
            ...
            $http({method: 'POST', headers: {'Content-Type': 'application/x-www-form-urlencoded'}, url: '<?php echo site_url('admin/activity/add_category'); ?>', data: "category_name=" + $scope.categoryText + "&<?php echo $this->security->get_csrf_token_name(); ?>=" + cct}).
