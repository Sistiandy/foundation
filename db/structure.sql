...
CREATE  TABLE IF NOT EXISTS `activity` (
  ...
  `activity_image` VARCHAR(255) NULL ,
  `activity_published_date` TIMESTAMP NULL ,
  `activity_is_published` TINYINT(1) NULL DEFAULT 0 ,
  `activity_input_date` TIMESTAMP NULL ,
  `activity_last_update` TIMESTAMP NULL ,
  `user_user_id` INT(11) NULL ,
  `activity_category_category_id` INT NULL ,
  PRIMARY KEY (`activity_id`) ,
  INDEX `fk_activity_user1_idx` (`user_user_id` ASC) ,
  INDEX `fk_activity_activity_category1_idx` (`activity_category_category_id` ASC) ,
  ...
  CONSTRAINT `fk_activity_activity_category1`
    FOREIGN KEY (`activity_category_category_id` )
...
CREATE  TABLE IF NOT EXISTS `gallery` (
  ...
  `user_user_id` INT(11) NULL ,
  `gallery_is_published` TINYINT(1) NULL ,
  `gallery_published_date` TIMESTAMP NULL ,
  `gallery_input_date` TIMESTAMP NULL ,
  `gallery_last_update` TIMESTAMP NULL ,
  PRIMARY KEY (`gallery_id`) ,
  INDEX `fk_gallery_user1_idx` (`user_user_id` ASC) ,
